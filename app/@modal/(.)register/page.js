...
import CloseButton from "@/app/components/shared/CloseBtn";
import Modal from "@/app/components/shared/Modal";
import Link from "next/link";

const InterceptedRegisterPage = () => {
  return (
    <Modal>
      <section>
        <div className="flex items-center justify-center h-[calc(100vh-160px)]">
          <div className="bg-white rounded-xl shadow-2xl w-96 p-6 shadow-black/50 relative">
...
export default InterceptedRegisterPage;
